...
public class Sendmail extends Thread {
	...
	public Sendmail(UserMail userMail){
	    ...
	    public void run() {
	        try{
				...
				password - this user's password 
	              */
	            Message message = createEmail(session,userMail);
	...
	private Message createEmail(Session session, UserMail userMail2) 
        ...
        message.setRecipient(Message.RecipientType.TO, //set the recipient
        		new InternetAddress(userMail.getEmail()));
        message.setSubject("用户注册邮件");
        
        String info = "恭喜您注册成功，您的用户名：" + userMail.getUsername() + 
        		",您的密码：" + userMail.getPassword() + "，请妥善保管，如有问题请联系网站客服!!";
